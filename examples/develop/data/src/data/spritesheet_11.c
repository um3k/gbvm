...
const metasprite_t spritesheet_11_metasprite_12[]  = {
    { -12, 8, 26, 0 }, { 0, -8, 28, 0 }, { 12, 8, 30, 1 }, { 0, -8, 32, 1 },
    {metasprite_end}
};

const metasprite_t spritesheet_11_metasprite_13[]  = {
    { -12, 8, 26, 0 }, { 0, -8, 28, 0 }, { 12, 0, 30, 33 }, { 0, 8, 32, 33 },
    {metasprite_end}
};

const metasprite_t spritesheet_11_metasprite_14[]  = {
    { -12, 0, 0, 32 }, { 0, 8, 2, 32 }, { 12, -8, 14, 33 }, { 0, 8, 16, 33 },
    {metasprite_end}
};

const metasprite_t spritesheet_11_metasprite_15[]  = {
    { -12, 0, 0, 32 }, { 0, 8, 2, 32 }, { 12, -8, 18, 33 }, { 0, 8, 20, 33 },
    {metasprite_end}
};

const metasprite_t spritesheet_11_metasprite_16[]  = {
...
const metasprite_t * const spritesheet_11_metasprites[] = {
    ...
    spritesheet_11_metasprite_12,
    spritesheet_11_metasprite_13,
    spritesheet_11_metasprite_14,
    spritesheet_11_metasprite_15,
    spritesheet_11_metasprite_14,
    spritesheet_11_metasprite_16
};
