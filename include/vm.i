...
.macro VM_REPLACE_TILE TARGET_TILE, TILEDATA_BANK, TILEDATA, START_IDX, LEN_IDX
        .db OP_VM_REPLACE_TILE, #>LEN_IDX, #<LEN_IDX, #>START_IDX, #<START_IDX, #>TILEDATA, #<TILEDATA, #<TILEDATA_BANK, #<TARGET_TILE
.endm
