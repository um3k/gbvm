...
static const UBYTE obj0_fade_vals[] = {0x00, 0x00, 0x40, 0x90, 0xA4, 0xE4, 0xE4};
static const UBYTE obj1_fade_vals[] = {0x00, 0x00, 0x40, 0x90, 0x90, 0xE0, 0xE0};
static const UBYTE bgp_fade_vals[] =  {0x00, 0x00, 0x40, 0x90, 0xA4, 0xE4, 0xE4};

static const UBYTE obj0_fade_black_vals[] = {0xFF, 0xFF, 0xFE, 0xE9, 0xE5, 0xE4, 0xE4};
static const UBYTE obj1_fade_black_vals[] = {0xFF, 0xFF, 0xFA, 0xF5, 0xF5, 0xE0, 0xE0};
